...
```{r Notes, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Import Data, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Tidying the Data, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Weighted Means, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Initial Summary Data, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Initial Summary Plots, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Printing Summary Plots, eval=FALSE, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Weighted Means Variance and Percentage Change, echo=FALSE, cache=FALSE}
...
```{r Weighted Means Variance and Percentage Change Table, echo=FALSE, cache=FALSE}
kable_names <- "Measure"
for (i in 1:9){
...
```{r Best Subsets, include=FALSE, cache=FALSE}
...
```{r part_tu04 Summary Model, message=FALSE, echo=FALSE, warning=FALSE, cache=FALSE}
...
```{r Sex Weighted Means, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r part_tu04 Sex Model, message=FALSE, echo=FALSE, warning=FALSE, cache=FALSE}
...
```{r part_tu04 Sex Plot, message=FALSE, eval=FALSE, echo=FALSE, cache=FALSE}
...
part_tu04_sex_TRCHILDNUM_plot <- ggplot(part_sex_weighted_means_data, aes(x=TUYEAR, y=part_tu04)) +
  ...
  geom_smooth(method = "lm", data=part_sex_weighted_means_TRCHILDNUM, aes(x=as.numeric(as.character(TUYEAR)), y=TRCHILDNUM, col=TESEX), se=FALSE, linetype="dashed", size=1.2) +
  ...
  scale_x_continuous(breaks = seq(2003,2017,2)) + xlab("Year") + ylab("Average number of children") + labs(caption = "Data Source: ATUS Survey", title = "Hypothesised parallels between number of children and the time spent caring for household members",color="Sex", fill="Sex") + theme(axis.title.y = element_text(margin = margin(t = 0, r = 10, b = 0, l = 0)), axis.title.x = element_text(margin = margin(t = 10, r = 0, b = 0, l = 0)), plot.title = element_text(size = 8))
```

```{r Suitability of the model, echo=FALSE, cache=FALSE}
...
\vspace{5pt}
```{r part_tu04 Sex Plot with Number of Children, message=FALSE, echo=FALSE, fig.height=4, cache=FALSE}
print(part_tu04_sex_TRCHILDNUM_plot)
```

```{r Linear model for the plot, eval=TRUE, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Adding TRCHILDNUM to model, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Testing the new model, eval=TRUE, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Sex Weighted Means Validation, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Linear model for the plot Validation, eval=TRUE, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r part_tu04 Sex Model Validation, message=FALSE, echo=FALSE, warning=FALSE, cache=FALSE}
...
```{r Adding TRCHILDNUM to model Validation, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r Testing the new model Validation, eval=TRUE, echo=FALSE, message=FALSE, fig.height=4, cache=FALSE}
...
```{r Plotting Data Tidying, echo=FALSE, message=FALSE, cache=FALSE}
#remove full time vs part time as has -1
...
```{r Sex Weighted Means Plotting, echo=FALSE, message=FALSE, cache=FALSE}
...
```{r part_tu04 Sex Model Plotting, message=FALSE, echo=FALSE, warning=FALSE, cache=FALSE}
...
```{r TRCHILDNUM Weighted Means Plotting, message=FALSE, echo=FALSE, warning=FALSE, fig.height=4}
...
part_tu04_sex_TRCHILDNUM_plot_plotting <- ggplot(part_sex_weighted_means_data_plotting, aes(x=TUYEAR, y=part_tu04)) +
  ...
  geom_smooth(method = "lm", data=part_sex_weighted_means_TRCHILDNUM_plotting, aes(x=as.numeric(as.character(TUYEAR)), y=TRCHILDNUM, col=TESEX), se=FALSE, linetype="dashed", size=1.2) +
  ...
  scale_y_continuous(sec.axis = sec_axis(~.*(1/0.1), name = "Spent any time at all caring for & \n helping nonhousehold members (%) \n")) +
  scale_x_continuous(breaks = seq(2003,2017,2)) + xlab("Year") + ylab("Average number of children") + labs(color="Sex", fill="Sex", caption = "Data Source: ATUS Survey", title = "Validated parallels between number of children and the time spent caring for household members") + theme(axis.title.y = element_text(margin = margin(t = 0, r = 10, b = 0, l = 0)), axis.title.x = element_text(margin = margin(t = 10, r = 0, b = 0, l = 0)), plot.title = element_text(size = 8))
```
...
\vspace{5pt}
```{r part_tu04 Sex Plot with Number of Children Plotting, message=FALSE, echo=FALSE, cache=FALSE}
print(part_tu04_sex_TRCHILDNUM_plot_plotting)
```

# How The Time Spent on Traditionally Gender Stereotyped Activities has Converged as Gender Roles Have Broken Down
...
kable(data.frame(Male.Activities, Female.Activities), caption  = "Traditionalist Gender Actitivies", format = "latex", booktabs = T,  col.names = c("Male Activites", "Female Activities"), align = c('l', 'r')) %>% kable_styling(full_width = T, latex_options = c("hold_position"))
```
...
kable(data.frame(Generations,Birth.Years),format = "latex", caption = "Generations", booktabs = T, col.names = c("Generation", "Birth Years"), align = c('l', 'r')) %>% kable_styling(full_width = T, latex_options = c("hold_position"))
```
...
\vspace{5pt}
```{r, echo=FALSE, warning=FALSE, fig.height=3.5, fig.width=9, fig.align='c', cache=TRUE}
