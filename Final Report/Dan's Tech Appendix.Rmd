...
# Encode Gender as M and F rather than a number
...
fit.models.and.plot <- function(Data, variable, mu) {
    ...
    n <- nrow(Data)
    # Commented code contrains different number of splines, it was decided to use as many splines as there are years in the data
    ...
    # Don't want to include the Silent Generation for Working and Childcare as this generation's values are all very close to 0 which caused some issues; uninteresting
...
fit.models.and.plot(Gender.Roles.Train, 'House.Maintenance', 30)
fit.models.and.plot(Gender.Roles.Train, 'Vehicle.Maintenance', 30)
...
fit.models.and.plot(Gender.Roles.Validate, 'House.Maintenance', 30)
fit.models.and.plot(Gender.Roles.Validate, 'Vehicle.Maintenance', 30)
...
fit.models.and.plot(Gender.Roles.Plotting, 'House.Maintenance', 30)
fit.models.and.plot(Gender.Roles.Plotting, 'Vehicle.Maintenance', 30)
