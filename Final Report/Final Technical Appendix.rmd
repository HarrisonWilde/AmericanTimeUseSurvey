...
```{r part_tu04 Sex Plot with Number of Children Plotting, message=FALSE, echo=TRUE}
...
```
The following plots show the low participation rate of Vehicle Maintenance and House Maintenance. 

```{r ggplot(Gender.Roles.Data, aes(x = TUYEAR, y = 100*(House.Maintenance > 0))) + geom_smooth() + labs(x = "Year", y = "Particpation Rate (%)", title = "Particpation rate of house maintenance", caption = "Data Source:ATUS Survey")
