...
- Fit a more complex model: glm with log link and multiplicative errors
  ...
  \vspace{8pt}
- Performing an $F$-test on the model shows this is a significant improvement on $tu04 participation \sim -1 + Sex:ns(Year, knots = 2003, 2005, ..., 2017)$
...
- Table 3 shows how to break down the respondents into different generation groups [@generations]  
...
- Following this initial check, general linear models were developed for all suitable activities and different parameters were checked including: 
    ...
    + Region
\vspace{5pt}
- After performing formal F-tests, the following model was settled upon for all activities
\vspace{5pt}
\fontsize{7}{2}
$Activity \sim -1 + Sex + Sex:ns(Year, knots = 2003, 2005, ..., 2017) + Generation + Generation:ns(Year, knots = 2003, 2005, ..., 2017)$
...
![](Working Validation Caption.png)

\fontsize{10}{10}
- The plots show the changes in working patterns between 3 generations. **Perhaps do another plot to show overall, as generations overpower all other effects here**
\vspace{5pt}
...
\vspace{7pt}
- On the other hand, the gap seems to have increased slightly for *Millennials* - both sexes are increasing the amount of time spent on housework, confounding effect of increased time due to age / moving out.
\vspace{7pt}
...
![](Childcare Validation Caption.png)
